...
<div id="fa-admin-panel">
    <div class="fa-panel-window">
        ...
        <div class="fa-tab-content active" id="fa-tab-add">
            ...
            <form id="fa-item-form" action="farm_admin/save_item.php" method="post" enctype="multipart/form-data" data-item-form>
                <label>Name
        ...
        <div class="fa-tab-content" id="fa-tab-edit">
            ...
            <div id="fa-edit-form-container" style="display:none;">
